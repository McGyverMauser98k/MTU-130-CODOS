...
C9A7   DD DE CB   LC9A7     CMP $CBDE,X					;COMPARE WITH SOME PREDEFINED KEYPRESS??
C9AA   F0 05                BEQ LC9B1
C9AC   CA                   DEX
C9AD   10 F8                BPL LC9A7						;UNTIL ONE IS IDENTIFIED
C9AF   30 E2                BMI LC993						;IF NOT TRY AGAIN
